...
wget -O /usr/bin/ceksstp https://raw.githubusercontent.com/${GitUser}/test1/main/ceksstp.sh && chmod +x /usr/bin/ceksstp
wget -O /usr/bin/xp-sstp https://raw.githubusercontent.com/${GitUser}/test1/main/xp-sstp.sh && chmod +x /usr/bin/xp-sstp
wget -O /usr/bin/renewsstp https://raw.githubusercontent.com/${GitUser}/test1/main/renewsstp.sh && chmod +x /usr/bin/renewsstp
rm -f /root/sstp.sh
