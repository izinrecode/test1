...
wget -O delvless "https://raw.githubusercontent.com/${GitUser}/test1/main/hapus/delvless.sh"
wget -O deltr "https://raw.githubusercontent.com/${GitUser}/test1/main/hapus/deltr.sh"
wget -O cekws "https://raw.githubusercontent.com/${GitUser}/test1/main/cekws.sh"
wget -O cekvless "https://raw.githubusercontent.com/${GitUser}/test1/main/cekvless.sh"
wget -O cektr "https://raw.githubusercontent.com/${GitUser}/test1/main/cektr.sh"
wget -O renewws "https://raw.githubusercontent.com/${GitUser}/test1/main/renewws.sh"
wget -O renewvless "https://raw.githubusercontent.com/${GitUser}/test1/main/renewvless.sh"
wget -O renewtr "https://raw.githubusercontent.com/${GitUser}/test1/main/renewtr.sh"
wget -O xp-ws "https://raw.githubusercontent.com/${GitUser}/test1/main/xp-ws.sh"
wget -O xp-tr "https://raw.githubusercontent.com/${GitUser}/test1/main/xp-tr.sh"
wget -O xp-vless "https://raw.githubusercontent.com/${GitUser}/test1/main/xp-vless.sh"
wget -O certv2ray "https://raw.githubusercontent.com/${GitUser}/test1/main/cert.sh"
chmod +x addws
chmod +x addvless
chmod +x addtr
chmod +x delws
