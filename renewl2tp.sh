...
user=$(grep -E "^### " "/var/lib/crot-script/data-user-l2tp" | cut -d ' ' -f 2 | sed -n "${CLIENT_NUMBER}"p)
...
sed -i "s/### $user $exp/### $user $exp4/g" /var/lib/crot-script/data-user-l2tp
clear
echo ""
echo " Akun L2TP berhasil diperpanjang"
echo " =========================="
